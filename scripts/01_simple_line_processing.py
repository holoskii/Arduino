...
def read_file():
    ...
    with open(file_path, 'r') as file:
        for line in file:
            ...
            if first_part != 'D':
                print(f"Line without data (not 'D'): {line}")
                continue
    ...
    return time_values, temp1_values, temp2_values, title

def update_graph(frame):
    time_values, temp1_values, temp2_values, title = read_file()
    plt.clf()
    plt.grid()
    ...
    plt.scatter(time_values, temp2_values, label='2', s=3)
